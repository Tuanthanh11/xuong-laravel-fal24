...
style="background-image: url(client/images/hero_1.jpg)"
data-aos="fade"
>
<div class="container">
    <div
    ...
    >
        <div
            class="col-md-5 text-center text-md-left pt-5 pt-md-0"
        >
    ...
    <div class="row">
        ...
        >
            <a class="block-2-item" href="#">
                <figure class="image">
                    <img
                        src="client/images/children.jpg"
                        alt=""
                        class="img-fluid"
                    />
                </figure>
